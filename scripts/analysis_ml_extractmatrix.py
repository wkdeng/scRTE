...
labels=factors[0]
#### Expression profiles
combined_exp=cell_exp.loc[:,[x for x in cell_exp.columns if x in rtes]+extended_markers]
combined_exp.to_csv('../data/analysis/combined_exp1460.txt',sep='\t',header=True,index=False)